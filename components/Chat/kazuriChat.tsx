...
//           configuration = {
//             ...configuration,
//             type: "RAG",  // Explicitly include type in configuration
//             embedding_model: "all-MiniLM-L6-v2",
//             prompt_template: `Instructions: ${instructions.trim()}
...
//       console.log('Creating agent with type:', agentType);
//       console.log('Configuration:', configuration);

//       // Create the agent
//       const newAgent = await apiService.createAgent({
//         name: name.trim(),
//         type: agentType,  // This should be "RAG" for RAG agents
//         configuration: configuration
//       });
...
//   // New tool creation states (for TOOL_CALLING)
...
//   // Auto-dismiss success messages (agent creation)
//   useEffect(() => {
//     let timeoutId: NodeJS.Timeout;
//     if (success) {
//       timeoutId = setTimeout(() => {
...
//   // Auto-dismiss success messages (tool creation)
//   useEffect(() => {
//     let timeoutId: NodeJS.Timeout;
//     if (toolCreationSuccess) {
//       timeoutId = setTimeout(() => {
//         setToolCreationSuccess(false);
//       }, 5000);
//     }
//     return () => {
//       if (timeoutId) clearTimeout(timeoutId);
...
//   // Toggle tool selection (choosing existing tools)
//   const toggleTool = (toolName: string) => {
//     setSelectedTools((prev) =>
//       prev.includes(toolName)
//         ? prev.filter((t) => t !== toolName)
...
//   // Validation for agent creation form
//   const isValid =
//     name.trim() &&
//     description.trim() &&
//     agentType &&
...
//     try {
//       const tool = await apiService.createTool(newToolDescription.trim());
...
//     setToolCreationLoading(true);
//     try {
//       const tool = await apiService.createToolFromCode(newToolCode.trim());
//       setTools((prev) => [...prev, tool]);
//       setToolCreationSuccess(true);
//       setNewToolCode("");
//     } catch (error) {
...
//           ? error.message
//           : "Failed to create tool from code"
//       );
//     } finally {
//       setToolCreationLoading(false);
//     }
...
//           Choose your agent type and configure its capabilities
//         </p>
//       </div>
...
//               <div className="space-y-4">
//                 <div
//                   className={`w-12 h-12 rounded-lg ${type.bgColor} flex items-center justify-center`}
//                 >
//                   <Icon className={`w-6 h-6 ${type.color}`} />
//                 </div>
//                 <div>
...
//           {/* TOOL_CALLING: Choose Existing Tools and/or Add a New Tool */}
//           {agentType === "TOOL_CALLING" && (
//             <>
//               {/* Existing Tools */}
//               <div className="space-y-4">
...
//                   <Button
//                     variant={
//                       toolCreationMode === "description" ? "default" : "outline"
//                     }
//                     onClick={() => {
...
//                       disabled={!newToolDescription.trim() || toolCreationLoading}
//                       className="mt-4"
//                     >
...
//                         rows={6}
//                         className="mt-1 w-full rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 font-mono"
//                       />
//                     </label>
//                     <Button
//                       onClick={handleCreateToolByCode}
//                       disabled={!newToolCode.trim() || toolCreationLoading}
//                       className="mt-4"
//                     >
...
// import "prismjs/themes/prism.css"; // Choose your preferred Prism theme
// import { Button } from "@/components/ui/button";
// import { Input } from "@/components/ui/input";
// import { Alert, AlertDescription } from "@/components/ui/alert";
// import { apiService, Agent, Tool } from "@/services/api";
...
//       setSuccess(true);
//       if (onConfigureAgent) onConfigureAgent(newAgent);
...
//                   {selectedTools.length > 0 && (
//                     <span className="text-sm text-gray-500">{selectedTools.length} tool(s) selected</span>
//                   )}
//                 </div>
//                 {isLoadingTools ? (
//                   <div className="text-center py-4">Loading available tools...</div>
...
//                   <div className="mt-4">
//                     <label className="block">
//                       <span className="text-gray-700 font-medium">Paste Your Python Code</span>
//                     </label>
//                     <div className="mt-1">
//                       <Editor
//                         value={newToolCode}
...
//                         padding={10}
//                         className="rounded-md border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 min-h-[150px] bg-gray-50"
//                         style={{
//                           fontFamily: "inherit",
//                           fontSize: "inherit",
//                         }}
...
//   );
// }
/////////////////////////////////////////////////////////////////////////The Above is my v2 - To revert to
"use client";
