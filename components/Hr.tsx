...
useEffect(() => {
  const fetchToken = async () => {
    const response = await fetch('https://test-hr-domain.auth.eu-west-1.amazoncognito.com/oauth2/token?grant_type=client_credentials', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'Authorization': 'Basic ' + btoa('7vcaue4n7q34foim8c22gmht12:1snscmen1ru14mfsbjp2h6rv1ov9rv783dhod0mhbisgfvsm3eom')
      }
    });
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(endpoint , {
        ...
        'x-api-key': 'ikTglJ7EQF57YETSC8LzE6a3aVvZ7p5y65fR9Asp',
