...
const ProductDiscovery: FC<ProductDiscoveryProps> = ({ endpoint }) => {
...
useEffect(() => {
    const fetchToken = async () => {
      const response = await fetch('https://test-cs-domain.auth.eu-west-1.amazoncognito.com/oauth2/token?grant_type=client_credentials', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
          'Authorization': 'Basic ' + btoa('5ham1gp9poa30qme67bttvbsp8:1g4oam70j2tav8inapr0li9b52j5i03h9uhmjt2rh3p26npitgdt')
        }
      });
