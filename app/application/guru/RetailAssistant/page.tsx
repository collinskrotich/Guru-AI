...
// git commit -m "implemented the product recommendation endpoint and changes the next.config file to accomodate both endpointe""use client"
...
//     try {
//       const res = await fetch('/api/v1/retail-product-recommendation-service', {
//         method: 'POST',
