  ...
  <div className="w-full max-w-xs">
    <div className="flex space-x-4">
      ...
      <a 
        ...
        className="flex-1 bg-white text-green-500 border border-green-500 py-3 px-6 rounded-full hover:bg-green-50 transition duration-300 text-lg font-semibold text-center"
      >
        Sign up
      </a>
    </div>
